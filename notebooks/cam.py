...
x = np.load('/data/YantiLiu/projects/subs_id/datasets/ir/test_x.npy')
y = np.load('/data/YantiLiu/projects/subs_id/datasets/ir/test_y.npy')
id = 114
...
model = resnet(**params)
path = '/data/YantiLiu/projects/subs_id/checkpoints/ir/Res_SE/2024-11-10_17_50mixer6_layer6/194_f1_8484.pth'
